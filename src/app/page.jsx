    ...
    <div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 mt-16">
        <div className="place-items-center place-content-center col-span-2 md:col-span-1 sm:col-span-2">
          ...
          /> */}
          <div className="bg-[url('/icono.png')] dark:bg-[url('/icono2.png')] w-[300px] min-h-[300px] bg-contain bg-no-repeat" alt="" width={'200px'} />
          <br />
          {/* <b className=" font-bold bg-clip-text text-transparent bg-gradient-to-b from-white to-gray-800 p-5">Duvan Ayala</b> */}
        </div>
        <div className=" md:p-0 md:text-[40px] col-span-2 lg:col-span-2 md:col-span-1 sm:p-16 sm:text-[20px] sm:col-span-2 md:leading-[52px] font-bold dark:bg-clip-text dark:text-transparent dark:bg-gradient-to-b dark:from-white dark:to-gray-800 p-5">
          Hola soy <span className="text-cyan-400">Duvan Ayala</span>, Desarrollador Fullstack freelance, creador de soluciones completas para
          tu negocio.

          <br />
          <TypeWriter data={typeWriter} className="text-[20px] text-cyan-400" />
          <br />
          <Button color="cyan" className="mt-5 rounded-[30px]">
            Descargar CV
          </Button>
        </div>
      </div>
      ...
      <div className="overflow-hidden w-full mt-16 place-items-center">
        <span className="dark:text-white font-bold tracking-[10px]">
          ALGUNAS EMPRESAS CON LAS QUE TRABAJE
        </span>
        <div className="overflow-hidden w-[80%] m-5">
          <div className="flex animate-marquee space-x-4 dark:grayscale ">
            <img
      ...
      <div className="w-full place-items-center mt-16">
        <div className=" p-5 rounded-xl  text-center w-[70%]">
          <span className="text-[40px] dark:text-white">💡 ¿Tienes un proyecto en mente? 🚀</span>
          <p className="dark:text-white">
            Hagámoslo realidad juntos. ¡Estoy aquí para ayudarte a desarrollarlo! 🌟
          </p>
          <br />
          <br />
          <a href="https://api.whatsapp.com/send?phone=573133236125&text=%F0%9F%92%A1%20Hola%2C%20tengo%20en%20mente%20un%20proyecto%20para%20desarrollar.%20%C2%BFPodemos%20hacerlo%20posible%3F%20%F0%9F%9A%80" target="_blank" className="px-4 py-2 text-white rounded-full float-right bg-cyan-400 font-bold">👉 Hablemos</a>
        </div>
      </div>
